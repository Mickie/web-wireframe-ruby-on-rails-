describe("InstagramView", function() 
{
  ...
  describe("showDialog", function()
  {
    ...
    {
      expect($("div#myMediaModal div.modal-body h3.mediaTitle")).toHaveText(InstagramData.mediaResponse.data[0].user.full_name);
    });

    it("adds the correct profile image to the modal", function() 
    {
      expect($("div#myMediaModal div.profile img")).toHaveAttr("src", InstagramData.mediaResponse.data[0].caption.from.profile_picture);
    });
