...
describe GameWatchesController do
  ...
  # GameWatch. As you add validations to GameWatch, be sure to
  ...
  # GameWatchesController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested game_watch as @game_watch" do
      game_watch = GameWatch.create! valid_attributes
      get :show, {:id => game_watch.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested game_watch as @game_watch" do
      game_watch = GameWatch.create! valid_attributes
      get :edit, {:id => game_watch.to_param}, valid_session
      assigns(:game_watch).should eq(game_watch)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new GameWatch" do
        expect {
          post :create, {:game_watch => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved game_watch as @game_watch" do
        ...
        post :create, {:game_watch => {}}, valid_session
        assigns(:game_watch).should be_a_new(GameWatch)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested game_watch" do
        ...
        put :update, {:id => game_watch.to_param, :game_watch => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested game_watch as @game_watch" do
        game_watch = GameWatch.create! valid_attributes
        put :update, {:id => game_watch.to_param, :game_watch => valid_attributes}, valid_session
        assigns(:game_watch).should eq(game_watch)
      end
    ...
    describe "with invalid params" do
      it "assigns the game_watch as @game_watch" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        GameWatch.any_instance.stub(:save).and_return(false)
        put :update, {:id => game_watch.to_param, :game_watch => {}}, valid_session
        assigns(:game_watch).should eq(game_watch)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested game_watch" do
      game_watch = GameWatch.create! valid_attributes
      expect {
        delete :destroy, {:id => game_watch.to_param}, valid_session
      }.to change(GameWatch, :count).by(-1)
    end
